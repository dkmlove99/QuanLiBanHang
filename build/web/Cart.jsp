...
<html lang="en">
    ...
    <%
        ...
        ArrayList<Order> orders
                = (ArrayList<Order>) session.getAttribute("orders");
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <a href="#"><b>DANH SÁCH HÓA ĐƠN</b></a>
        ...
        <form action="shoppingCart" id="lol" method="POST">
        ...
        <div class="container-fluid">
            ...
            <table class="table" id="table">
                ...
                <tr>
                    <td><%=o.getId()%></td>
                    <td><%=o.getDate()%></td>
                    <td><%=o.getCustomer().getTenKhach()%></td>
                    <td><%=formatter.format(o.getTotal())%></td>
                    <td>
