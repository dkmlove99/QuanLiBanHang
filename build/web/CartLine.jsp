...
<html lang="en">
    ...
    <%
        ...
        ArrayList<OrderLine> orderLines
                = (ArrayList<OrderLine>) session.getAttribute("orderLines");
...
<div class="wrapper">
    ...
    <div id="content">
        ...
        %>
        <h2>Tên Khách Hàng :&emsp; <%=o.getOrder().getCustomer().getTenKhach()%></h2>
        <h2>NGÀY MUA HÀNG :&emsp; <%=o.getOrder().getDate()%></h2>
        <% break;
            }%>
            <table class="table" id="table">
                ...
                %>
                <tr>
                    <td><%=o.getProduct().getNameHangHoa()%></td>
                    <td><%=o.getQuantity()%></td>
                ...
                <tr>
                    <th scope="col"></th>
                    <th scope="col"></th>
                    <td><%=formatter.format(o.getOrder().getTotal())%></td>                 
                    <th scope="col"></th>
                </tr>
                <%break;
                }%>
